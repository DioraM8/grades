...
<div id="gameContainer">
    ...
    <div id="hud">
        <div class="holographic-panel" id="topPanel">
        ...
        <div class="holographic-panel" id="rightPanel">
        ...
        <div class="holographic-panel" id="bottomPanel">
            <div style="color: #00ffff; font-size: 16px; margin-bottom: 10px;">
                🚀 NEURAL INTERFACE CONTROLS
            </div>
            <div style="font-size: 14px; color: #ffff00;">
                MOUSE: Navigate 3D Space • CLICK: Investigate Celestial Bodies • SCROLL: Zoom Through Dimensions
            </div>
        </div>
    </div>
    ...
    <div id="challengeModal">
        <div class="modal-content">
            ...
            <button id="nextButton" style="display: none;">CONTINUE EXPLORATION</button>
        </div>
    </div>
    ...
    function setupEventListeners() {
        ...
        document.addEventListener('click', (e) => {
            ...
            if (intersects.length > 0) {
                ...
                if (clicked.userData && clicked.userData.planetData) {
...
function toggleQuantumView(active) {
    // Quantum view effect: wireframe visualization
    solarSystem.planets.forEach(planetGroup => {
        const planet = planetGroup.children[0]; // Main planet mesh
        if (active) {
...
function animate() {
    ...
    if (!gameState.isPaused) {
        ...
        // Update raycaster for planet hovering
        raycaster.setFromCamera(mouse, camera);
        const intersects = raycaster.intersectObjects(intersectObjects);
        if (intersects.length > 0) {
            cursor.style.borderColor = '#ff0000';
            cursor.style.boxShadow = '0 0 30px #ff0000, inset 0 0 15px #ff0000';
        } else {
            cursor.style.borderColor = '#00ffff';
            cursor.style.boxShadow = '0 0 20px #00ffff, inset 0 0 10px #00ffff';
        }
    }
